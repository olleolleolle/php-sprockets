...
to parse any text file is new. I think that's a good addition and a very obvious one too. Along with 
existing PHP formatters (jsmin, cssmin, etc..) and caching this can become very powerful for processing
your assets. - So sprockets now can deal with CSS, too. Yay!
